        ...
        <div className='sidebar' style={{ width: width, height: height }}>
            <div className="container">
                <div className="inner-container">
                    ...
                    <h1 style={{ textAlign: 'center', color: 'rgb(0, 136, 255)', marginTop: '20px' }}>Analog Clock</h1>
                    <p className='desc'>This is a fully functional analog clock created using HTML5, HTML5 Canvas, Javascript + Typescript, React JS, CSS, React MUI and Firebase for hosting.</p>
                    <div className="icon-container">
                        <img src={HTML} width={50} height={50} />
                        <img src={CSS} width={50} height={50} />
                        <img src={JS} width={50} height={50} />
                        <img src={TS} width={50} height={50} />
